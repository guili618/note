...
[supervisord]
logfile=/home/guiax/supervisor/supervisord.log    ; supervisord log file
...
[program:echo]
command=bash /home/guiax/echo.sh
stderr_logfile = /home/guiax/supervisor/echo-stderr.log
stdout_logfile = /home/guiax/supervisor/echo-stdout.log
```