...
Well, you just have everything needed to understand decorators.
 You see, decorators are “wrappers”, which means that they let you execute code before 
...
another_stand_alone_function = my_shiny_new_decorator(
    another_stand_alone_function)
...
def decorator_maker_with_arguments(decorator_arg1, decorator_arg2):
    ...
    print("I make decorators! And I accept arguments: {0}, {1}".format(
    ...
    def my_decorator(func):
        ...
        print("I am the decorator. Somehow you passed me arguments: {0}, {1}".format(
            decorator_arg1, decorator_arg2))
